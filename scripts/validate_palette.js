// Vendored verbatim from the dataviz skill (scripts/validate_palette.js) — kept
// close to upstream so it stays in sync when the skill updates. Excluded from
// oxlint in .oxlintrc.json rather than reformatted to house style.
/**
